...
{
    public class MyActionFilterB : ActionFilterAttribute, IActionFilter
    {
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            Console.WriteLine($"当前过滤器:{nameof(MyActionFilterB)} ControllerName:{actionDescript.ControllerName} ActionName:{actionDescript.ActionName}执行前....");
        ...
        public override void OnActionExecuted(ActionExecutedContext context)
        {
            ...
            Console.WriteLine($"当前过滤器:{nameof(MyActionFilterB)} ControllerName:{controllerActionDescriptor.ControllerName} ActionName:{controllerActionDescriptor.ActionName}执行后....");
